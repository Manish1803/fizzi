...
export default function Scene({ sentence, flavor }: SkyDiveProps) {
  ...
  const cloundsRef = useRef<THREE.Group>(null);
  ...
  useGSAP(() => {
    ...
    gsap.set(cloundsRef.current.position, { z: 10 });
    ...
    scollTl
      ...
      .to(cloundsRef.current.position, { z: 0, duration: 0.3 }, 0)
      ...
      .to(cloundsRef.current.position, { z: 7, duration: 0.5 });
  });
